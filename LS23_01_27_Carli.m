...
%% USER: Basic Aspects 
    ...
    %export to.
ImgFile=char('D:\Dropbox (VU Basic Sciences)\Duvall Confocal\Duvall Lab\Larry Stokes\23_01_31_Carli Gal8_2nd attempt\20230131_5_55pm.nd2');
exportdir=char('D:\Dropbox (VU Basic Sciences)\Duvall Confocal\Duvall Lab\Larry Stokes\Gal8 Processing\20230127_Carli_Gal8_2nd try');
...
%                          {{'Nuc'},{1},{1 0.02},{3},{'Nuc_bw4_perim' [0.8500 0.3250 0.0980]},{true},{}};
                          {{'Cyt'},   {2},{2 0.13},   {2},    {[0 1 1]},{true},{[0 0.2]}};  
